...
export class RESTManager {
	 ...
	 */
	public async getClanWarLeagueRound(warTag: string, options?: OverrideOptions) {
	 ...
	 * Get a League info.
	 */
	public async getLeague(leagueId: number | string, options?: OverrideOptions) {
	 ...
	 */
	public async getLeagueSeasons(leagueId: number, options?: SearchOptions) {
		const query = Util.queryString(options);
	 ...
	 */
	public async getSeasonRankings(leagueId: number, seasonId: string, options?: SearchOptions) {
		const query = Util.queryString(options);
	 ...
	 */
	public async getWarLeague(leagueId: number, options?: OverrideOptions) {
	 ...
	 */
	public async getLocation(locationId: number, options?: OverrideOptions) {
	 ...
	 */
	public async getClanRanks(locationId: number | string, options?: SearchOptions) {
		const query = Util.queryString(options);
	 ...
	 */
	public async getPlayerRanks(locationId: number | string, options?: SearchOptions) {
		const query = Util.queryString(options);
	 ...
	 */
	public async getVersusClanRanks(locationId: number | string, options?: SearchOptions) {
		const query = Util.queryString(options);
	 ...
	 */
	public async getVersusPlayerRanks(locationId: number | string, options?: SearchOptions) {
		const query = Util.queryString(options);
